...
public class 插入排序 {
    ...
    private static final int[] before_random_queue = {83, 80, 7, 1, 30, 22, 52, 47, 15, 73, 63, 63, 21, 25, 4, 2, 76, 33, 50, 81, 27, 79, 7, 93, 75, 7, 5, 95, 0, 9, 19, 76, 34, 39, 94, 31, 64, 24, 43, 59, 65, 53, 62, 31, 91, 66, 81, 35, 1, 33, 87, 45, 90, 82, 68, 94, 20, 41, 33, 84, 80, 82, 18, 49, 51, 36, 57, 6, 53, 2, 50, 93, 22, 26, 13, 41, 18, 0, 83, 37, 91, 67, 60, 56, 74, 19, 79, 28, 27, 35, 60, 60, 97, 57, 0, 49, 26, 29, 35, 13};
    ...
    private static final int num = before_random_queue.length;

    private int[] after_queue = Arrays.copyOf(before_random_queue, before_random_queue.length);

    private long start_nano;

    private long end_nano;
